...
sudo apt install vim curl tree gparted obs-studio persepolis mpv yt-dlp handbrake papirus-icon-theme bibata-cursor-theme kdeconnect gnome-shell-extension-gsconnect -y
